...
class StripeProvider {
    async createCheckout(purchaseId, _themeId, amount, currency) {
        ...
        throw new Error('Stripe provider not configured. Set PAYMENT_PROVIDER=fakepay or provide STRIPE_SECRET_KEY.');
    }
